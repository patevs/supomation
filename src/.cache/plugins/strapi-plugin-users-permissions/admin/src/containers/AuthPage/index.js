    ...
    handleSubmit = e => {
        ...
        const formErrors = Object.keys(modifiedData).reduce((acc, key) => {
            ...
            if (
                ...
                if (modifiedData.password.length < 6) {
                    acc.push({
                        ...
                        errors: [
                            {
                                id:
                                    'users-permissions.components.Input.error.password.length'
                            }
                        ]
                    });
                }
                ...
                if (
                    get(modifiedData, 'password') !==
                    get(modifiedData, 'confirmPassword')
                ) {
                    acc.push({
                        ...
                        errors: [
                            {
                                id:
                                    'users-permissions.components.Input.error.password.noMatch'
                            }
                        ]
                    });
                }
    ...
    renderButton = () => {
        ...
        return (
            <div className={cn('col-md-12', styles.buttonContainer)}>
                <Button
                    className={cn(
                        isEmailForgotSent && styles.buttonForgotSuccess
                    )}
                    label={label}
                    style={{ width: '100%' }}
