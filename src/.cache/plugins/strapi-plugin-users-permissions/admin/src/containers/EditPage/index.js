...
export class EditPage extends React.Component {
    ...
    getChildContext = () => ({
        ...
        resetShouldDisplayPoliciesHint: this.props
            .resetShouldDisplayPoliciesHint
    });
            ...
            return this.props.setErrors([
                {
                    ...
                    errors: [
                        {
                            id:
                                'users-permissions.EditPage.form.roles.name.error'
                        }
                    ]
                }
            ]);
        ...
        <React.Fragment>
            ...
            <InputSearch
                ...
                label={{
                    ...
                    params: {
                        number: size(
                            get(this.props.editPage, ['modifiedData', 'users'])
                        )
                    }
                }}
