...
export const GET_PERMISSIONS_SUCCEEDED =
    'UsersPermissions/EditPage/GET_PERMISSIONS_SUCCEEDED';
export const GET_POLICIES = 'UsersPermissions/EditPage/GET_POLICIES';
export const GET_POLICIES_SUCCEEDED =
    'UsersPermissions/EditPage/GET_POLICIES_SUCCEEDED';
export const GET_ROLE = 'UsersPermissions/EditPage/GET_ROLE';
export const GET_ROLE_SUCCEEDED =
    'UsersPermissions/EditPage/GET_ROLE_SUCCEEDED';
export const GET_ROUTES_SUCCEEDED =
    'UsersPermissions/EditPage/GET_ROUTES_SUCCEEDED';
export const GET_USER = 'UsersPermissions/EditPage/GET_USER';
export const GET_USER_SUCCEEDED =
    'UsersPermissions/EditPage/GET_USER_SUCCEEDED';
...
export const RESET_SHOULD_DISPLAY_POLICIES_HINT =
    'UsersPermissions/EditPage/RESET_SHOULD_DISPLAY_POLICIES_HINT';
export const SELECT_ALL_ACTIONS =
    'UsersPermissions/EditPage/SELECT_ALL_ACTIONS';
...
export const SET_INPUT_POLICIES_PATH =
    'UsersPermissions/EditPage/SET_INPUT_POLICIES_PATH';
export const SET_ROLE_ID = 'UsersPermissions/EditPage/SET_ROLE_ID';
export const SET_SHOULD_DISPLAY_POLICIES_HINT =
    'UsersPermissions/EditPage/SET_SHOULD_DISPLAY_POLICIES_HINT';
