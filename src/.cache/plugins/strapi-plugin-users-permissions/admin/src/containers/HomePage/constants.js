...
export const DELETE_DATA_SUCCEEDED =
    'UsersPermissions/HomePage/DELETE_DATA_SUCCEEDED';
export const FETCH_DATA = 'UsersPermissions/HomePage/FETCH_DATA';
export const FETCH_DATA_SUCCEEDED =
...
export const UNSET_DATA_TO_EDIT =
    'UsersPermissions/HomePage/UNSET_DATA_TO_EDIT';
