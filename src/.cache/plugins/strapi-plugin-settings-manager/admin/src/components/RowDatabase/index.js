            ...
            >
                <div className={styles.stmflexLi}>
                    <div className={styles.stmflexed}>
                        ...
                        <div
                            className={styles.stmlabel}
                            style={{ fontWeight: '500' }}
                        >
                            {this.props.data.name}
                        </div>
                    </div>
                    <div className={styles.stmdbHost}>
                        {this.props.data.host}
                    </div>
                    <div
                        className={styles.stmcentered}
                        style={{ width: '15rem' }}
                    >
                    ...
                    >
                        ...
                        <div
                            className={`${styles.stmleftSpaced} ${styles.stmico}`}
                        >
                            <i
                                id="trash"
                ...
                <div>
                    <PopUpWarning
                        ...
                        content={content}
                        popUpWarningType={
                            this.props.data.isUsed ? 'danger' : 'warning'
                        }
