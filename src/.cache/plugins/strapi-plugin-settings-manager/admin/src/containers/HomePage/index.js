...
export class HomePage extends React.Component {
    ...
    componentDidUpdate(prevProps) {
        ...
        if (
            prevProps.home.didCreatedNewDb !== this.props.home.didCreatedNewDb
        ) {
            this.handleFetch(this.props);
        }
    }
    ...
    getDatabase = databaseName => {
        ...
        this.props.specificDatabaseFetch(
            databaseName,
            this.props.match.params.env
        );
    ...
    handleChange = ({ target }) => {
        ...
        if (this.props.match.params.slug === 'databases') {
            if (name === this.props.home.dbNameTarget) {
                const formErrors =
                    value ===
                    this.props.home.addDatabaseSection.sections[1].items[0]
                        .value
                        ? [
                              {
                                  target: name,
                ...
                const item = find(
                    this.props.home.addDatabaseSection.sections[0].items[1]
                        .items,
                    { value }
                );
    ...
    renderComponent = () => {
        ...
        const addRequiredInputDesign =
            this.props.match.params.slug === 'databases';
                ...
                <div className="row">
                    ...
                    <div className={`${styles.stmhome} col-md-9`}>
                        ...
                        <ContentHeader
                            name={this.props.home.configsDisplay.name}
                            description={
                                this.props.home.configsDisplay.description
                            }
                        />
