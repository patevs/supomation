...
export class ModelPage extends React.Component {
    ...
    shouldRedirect = () => {
        ...
        return (
            models.findIndex(model => model.name === this.getModelName()) ===
        ...
        return (
            <div className={styles.modelpage}>
                        ...
                        <LeftMenu>
                            <LeftMenuSection>
                                <LeftMenuSectionTitle
                                    id={this.getSectionTitle()}
                                />
                                <ul>
                                    {this.renderLinks()}
                                    <CustomLink
                                        onClick={
                                            this.handleClickOpenModalCreateCT
                                        }
                                    />
                                </ul>
                            </LeftMenuSection>
                        ...
                        <div className="col-md-9">
                            <div className={styles.componentsContainer}>
                                <PluginHeader
                                    ...
                                    onClickIcon={
                                        this.handleClickEditModelMainInfos
                                    }
                                />
                                {this.getModelAttributesLength() === 0 ? (
                                    <EmptyAttributesBlock
                ...
                <AttributeForm
                    ...
                    alreadyTakenAttributes={Object.keys(
                        this.getModelAttributes()
                    )}
