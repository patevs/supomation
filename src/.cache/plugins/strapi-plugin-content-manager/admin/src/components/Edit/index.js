...
class Edit extends React.PureComponent {
    ...
    getUploadRelations = props =>
        Object.keys(get(props.schema, 'relations', {})).reduce(
            (acc, current) => {
                if (
                    get(props.schema, ['relations', current, 'plugin']) ===
                    'upload'
                ) {
                    acc[current] = {
                        description: '',
    ...
    orderAttributes = () =>
        get(this.props.schema, ['editDisplay', 'fields'], []);
    ...
    renderAttr = (attr, key) => {
        ...
        return (
            <Input
                ...
                placeholder={
                    get(layout, 'placeholder') || details.placeholder || ''
                }
