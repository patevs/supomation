...
export const DELETE_DATA_SUCCESS =
    'ContentManager/ListPage/DELETE_DATA_SUCCESS';
export const DELETE_SEVERAL_DATA =
    'ContentManager/ListPage/DELETE_SEVERAL_DATA';
export const DELETE_SEVERAL_DATA_SUCCESS =
    'ContentManager/ListPage/DELETE_SEVERAL_DATA_SUCCESS';
...
export const ON_CLICK_SELECT_ALL =
    'ContentManager/ListPage/ON_CLICK_SELECT_ALL';
export const ON_TOGGLE_DELETE_ALL =
    'ContentManager/ListPage/ON_TOGGLE_DELETE_ALL';
export const ON_TOGGLE_FILTERS = 'ContentManager/ListPage/ON_TOGGLE_FILTERS';
export const OPEN_FILTERS_WITH_SELECTION =
    'ContentManager/ListPage/OPEN_FILTERS_WITH_SELECTION';
...
export const RESET_DISPLAYED_FIELDS =
    'ContentManager/ListPage/RESET_DISPLAYED_FIELDS';
export const SET_DISPLAYED_FIELDS =
    'ContentManager/ListPage/SET_DISPLAYED_FIELDS';
